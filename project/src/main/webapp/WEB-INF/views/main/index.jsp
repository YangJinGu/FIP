                                        ...
                                        <div class="hover-content">
                                            <div class="inner">
                                                ...
                                                <div class="main-border-button">
                                                    <a class="inner_a" onclick="fn_shopList('W')">바로가기</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="thumb">
                                        ...
                                        <div class="hover-content">
                                            <div class="inner">
                                                ...
                                                <div class="main-border-button">
                                                    <a class="inner_a" onclick="fn_shopList('M')">바로가기</a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb eveBN">
                                        <div class="inner-content">
                                            <h4>Dr.martens</h4>
                                            <span>Best Clothes For Dr.martens</span>
                                        </div>
                                        <div class="hover-content">
                                            <div class="inner">
                                                <h4>닥터마틴 입점 행사</h4>
                                                <p>닥터마틴 행사 보러 가기.</p>
                                                <div class="main-border-button">
                                                    <a class="inner_a" onclick="fn_eventList('dm')">바로가기</a>
                                                </div>
                                            </div>
                                        </div>
