...
function fn_list(curPage){
	document.myLikeStyleListForm.curPage.value = curPage;
	document.myLikeStyleListForm.action = "/myPage/myLikeStyleList";
	document.myLikeStyleListForm.submit();
}
...
<main>
    ...
    <form id="myLikeStyleListForm" name="myLikeStyleListForm" method="post">
