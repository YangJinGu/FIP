  	...
  	<c:if test="${!empty list}">
		<c:forEach var="zzimList" items="${list}" varStatus="status">
                ...
                <tr class="zzim_tr">
                    ...
                    <td class="zzim_pay"><fmt:formatNumber type="number" maxFractionDigits="3" value="${zzimList.productPrice}" />원</td>
                    <td>
                        <button class="zzim_btn"  onclick="deleteZzim('${zzimList.productNo}') /myPage/deleteZzim여기로  ">삭제</button>
                    </td>
                </tr>
         </c:forEach>
    </c:if>
